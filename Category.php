         ...
         <div class="row">
           ...
           <div class="col-md-6">
             <form class="form" action="Category.php<?=((isset($_GET['edit']))?'?edit='.$edit_id:'');?>" method="post">
               ...
               <div class="form-group">
                 <input type="submit" value="<?=((isset($_GET['edit']))?'Edit':'Add');?> Category" class="btn btn-success" style="border-radius: 4px;">
               </div>
             </form>
           </div>
             ...
             <table class="table table-bordered" style="width:auto; margin:0 auto;">
               ...
               <tbody>
                 ...
                 <tr class="text-light bg-dark">
                   ...
                   <td>Parent</td>
                   <td>
                      <a href="Category.php?edit=<?=$parent['id']?>"><span class="fa fa-pencil"></span></a>
                      <a href="Category.php?delete=<?=$parent['id']?>"><span class="fa fa-close"></span></a>
                   </td>
                 </tr>
                 <?php while($child = mysqli_fetch_assoc($cresult)): ?>
                  <tr>
                   ...
                   <td><?=$parent['category']?></td>
                   <td>
                      <a href="Category.php?edit=<?=$child['id']?>"><span class="fa fa-pencil"></span></a>
                      <a href="Category.php?delete=<?=$child['id']?>"><span class="fa fa-close"></span></a>
                   </td>
                 </tr>
                 <?php endwhile; ?>
               <?php endwhile; ?>
